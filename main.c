...
int main()
{
    ...
    // G�n�rer et retourner un nombre al�atoire de 5 chiffres
    ///printf("%\n",rand() % 90000 + 10000) ;
                ...
                do {
                    ...
                    switch (option1) {
                        ...
                        case 3:
                            ...
                            afficherClient(c);
                            // Modifier les donn�es du client c (par exemple, mettre à jour les informations)
                            printf("Saisir les nouveaux données du client \n");
                            ajouterClient(&c,stockvoiture,nbVoitures );
                            // Ecrire les données mises à jour dans le fichier principal
                            fseek(fp, x, 0); // Se repositionner au même emplacement dans le fichier principal
                            ecrireUnClientDansFichier(fp, c); // Ecrire les données du client modifié dans le fichier
                     break;
                     case 4:
